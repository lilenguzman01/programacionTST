class Propiedad:
    ...
    def _str(self):
        print("Id Tipo: "+self.Id_Tipo)
        print("Id Estado: "+self.Id_Estado)
        print("Id Operatoria Comercial: " +self.Id_Operatoria_Comercial)
        print("Id Propietario: "+self.Id_Propietario)
